...
const ControlledCheckbox = (props: ComponentProps<typeof Checkbox>) => {
  ...
  return (
    <div>
      ...
      >
        ...
        >
          <li>
            <strong>Tab</strong>: 次のチェックボックスにフォーカス移動
          </li>
          <li>
            <strong>Shift + Tab</strong>: 前のチェックボックスにフォーカス移動
          </li>
          <li>
            <strong>Space</strong>: チェックの切り替え
          </li>
          <li>
...
export const Default: Story = {
  args: { label: "" } as any,
  render: () => <ControlledCheckbox label="利用規約に同意する" />,
};
...
export const ParentChild: Story = {
  args: { label: "" } as any,
  render: () => <ParentChildCheckboxDemo />,
};
