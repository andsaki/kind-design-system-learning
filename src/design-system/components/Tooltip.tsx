import { useState, useRef, cloneElement, isValidElement, useEffect, useCallback, useLayoutEffect } from 'react';
...
const isNaturallyFocusable = (element: ReactElement<HTMLAttributes<HTMLElement>>): boolean => {
...
export const Tooltip: React.FC<TooltipProps> = ({
  ...
  const shouldForceTabIndex =
    ...
    !isNaturallyFocusable(children as ReactElement<HTMLAttributes<HTMLElement>>) &&
