...
export const pandaColors: GetPandaConfigMap<"colors"> = {
  ...
  blue: {
    ...
    200: { value: '#90caf9' },
    300: { value: '#64b5f6' },
    400: { value: '#1e88e5' },  // より濃い青に変更 (コントラスト比改善)
    500: { value: '#1976d2' },  // より濃い青に変更 (コントラスト比改善)
    600: { value: '#1565c0' },  // より濃い青に変更 (コントラスト比改善)
    700: { value: '#0d47a1' },  // より濃い青に変更 (コントラスト比改善)
    800: { value: '#0a3d91' },  // 新規追加
    900: { value: '#073270' },  // 新規追加
  },
  // レッド - エラー、危険、削除操作
  red: {
    50: { value: '#ffebee' },
  ...
  orange: {
    ...
    200: { value: '#ffcc80' },
    300: { value: '#ffb74d' },
    400: { value: '#f57c00' },  // より濃いオレンジに変更 (コントラスト比改善)
    500: { value: '#ef6c00' },  // より濃いオレンジに変更 (コントラスト比改善)
    600: { value: '#e65100' },  // より濃いオレンジに変更 (コントラスト比改善)
    700: { value: '#d84315' },  // 新規追加
    800: { value: '#bf360c' },  // 新規追加
    900: { value: '#a62c00' },  // 新規追加
  },
  // ピンク - アクセント、強調表示
  pink: {
    50: { value: '#fce4ec' },
